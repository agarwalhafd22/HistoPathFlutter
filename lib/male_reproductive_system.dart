...
class MaleReproductiveSystem extends StatefulWidget {
  @override
  _MaleReproductiveSystemState createState() => _MaleReproductiveSystemState();
}

class _MaleReproductiveSystemState extends State<MaleReproductiveSystem> {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Wrap(
                        ...
                        runSpacing: 16.0,
                        children: [
                          _buildCard("Testis", () => _selectTopic("Thin Skin"), "assets/images/testis.jpg"),
                          _buildCard("Prostate", () => _selectTopic("Thick Skin"), "assets/images/prostate.jpeg"),
                        ],
                      ),
                    ],
                  ),
