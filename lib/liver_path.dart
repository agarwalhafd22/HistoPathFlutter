...
class LiverPath extends StatefulWidget {
  @override
  _LiverPathState createState() => _LiverPathState();
}
...
class _LiverPathState extends State<LiverPath> {
  ...
  Future<void> _loadImageFromFirebase() async {
    try {
      final Reference storageRef = FirebaseStorage.instance.ref().child('gastro/liver/patho/Liver cirrhosis.png');
          ...
          children: [
            ...
            Text(
              _isStarted
                  ...
                  : 'The tumor has infiltrating glandular pattern in the colonic wall with varying grades of differentiation of tumour cells. About 10 % cases show mucin secreting colloid carcinoma with pools of mucin. The cells lining the glands exhibit increased nuclear to cytoplasmic ratio, nuclear stratification nuclear hyperchromasia, loss of goblet cells. Surrounding areas shows desmoplastic reaction',
