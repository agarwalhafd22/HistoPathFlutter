...
class IntegumentarySystem extends StatefulWidget {
  @override
  _IntegumentarySystemState createState() => _IntegumentarySystemState();
}

class _IntegumentarySystemState extends State<IntegumentarySystem> {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Wrap(
                        ...
                        runSpacing: 16.0,
                        children: [
                          _buildCard("Thin Skin", () => _selectTopic("Thin Skin"), "assets/images/thinskin.jpg"),
                          _buildCard("Thick Skin", () => _selectTopic("Thick Skin"), "assets/images/thickskin.jpg"),
                        ],
                      ),
                    ],
                  ),
