...
class SkeletalSystem extends StatefulWidget {
  @override
  _SkeletalSystemState createState() => _SkeletalSystemState();
}

class _SkeletalSystemState extends State<SkeletalSystem> {
